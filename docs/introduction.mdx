...
<CardGroup cols={3}>
  <Card title="SwiftUI" href="/quickstart/ios/swiftui">
    A Swift package and a Support row.
  </Card>
  <Card title="UIKit" href="/quickstart/ios/uikit">
...
<CardGroup cols={3}>
  <Card title="JavaScript" href="/quickstart/web/javascript">
    One script tag, nothing to build.
  </Card>
  <Card title="React" href="/quickstart/web/react">
    A small component and your own button.
  </Card>
  <Card title="Vue" href="/quickstart/web/vue">
    Load on mount, open from a button.
  </Card>
  <Card title="Svelte" href="/quickstart/web/svelte">
    Load on mount, open from a button.
  </Card>
  <Card title="Next.js" href="/quickstart/web/nextjs">
    Once in the root layout.
  </Card>
  <Card title="Astro" href="/quickstart/web/astro">
    Two lines in your shared layout.
  </Card>
  <Card title="WordPress" href="/quickstart/web/wordpress">
    From your theme or a small plugin.
  </Card>
  <Card title="Webflow" href="/quickstart/web/webflow">
