...
The `open` function lives in the script because a Vue template can't reach the global `Feddy` object directly. Leave out `launcher: false` if you'd rather have the floating button instead of your own.
